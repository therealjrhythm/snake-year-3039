...
export function GameplayGuide({ device, paused, state, onClose, onEnter }: {
  ...
  return <Modal title="HOW TO PLAY" subtitle="KNOW YOUR SYSTEMS" onClose={onClose} className="guide-dialog">
    ...
    <div className="guide-content" role="tabpanel" aria-label={tab}>
      ...
      {tab === 'Pickups' ? <>
        <p className="guide-intro">Powerups do not count toward your quota. <strong>Automatic bonuses start on contact.</strong> Bonus names and timers appear beside health; {legacy ? 'charges appear' : 'charges and ammunition appear'} in Tactical Systems.</p>
