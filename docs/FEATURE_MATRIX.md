...
Latest owner design revision (September 6, 2026): brighter, more saturated full-snake glow replaces the previous fixed-cyan-head requirement. Head/body lights and the direction marker share the selected color, while hostile red identification stays separate. POWERUP LAB is a full-size title action. This does not change progression, stats, collisions or save versions.
